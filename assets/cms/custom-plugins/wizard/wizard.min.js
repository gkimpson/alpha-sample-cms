...
;(function(b,l,m,h){var i=function(a,b){arguments.length&&this._init(a,b)};i.prototype={defaults:{element:".wizard-step",navLabelElement:".wizard-label",buttonContainer:".wizard-actions",navContainerClass:"wizard-nav",buttonContainerClass:"wizard-buttons",transition:null,onStepLeave:null,onStepShown:null,onBeforeSubmit:null,forwardOnly:!1,orientation:"horizontal",ajaxSubmit:!1,ajaxOptions:{},defaultButtonClass:"btn",responsiveNextButtonClass:"responsive-next-btn",responsivePrevButtonClass:"responsive-prev-btn",
submitButtonClass:"btn-danger pull-right",responsiveNextButtonLabel:'<i class="icon-caret-right"></i>',responsivePrevButtonLabel:'<i class="icon-caret-left"></i>',nextButtonLabel:"Next",prevButtonLabel:"Prev",submitButtonLabel:"Submit"},_activeStepId:null,_steps:null,_buttons:null,_nav:null,_init:function(a,c){this.element=b(a);this.options=b.extend({},this.defaults,c,this.element.data());b.inArray(this.options.orientation,["horizontal","vertical"])||(this.options.orientation="horizontal");b.fn.ajaxForm&&
