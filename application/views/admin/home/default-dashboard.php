                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="btn-group">
                                            <a href="<?= base_url() ?>assets/cms/#" class="btn btn-small"><i class="icon-search"></i></a>
                                            <a href="<?= base_url() ?>assets/cms/#" class="btn btn-small"><i class="icon-pencil"></i></a>
                                            <a href="<?= base_url() ?>assets/cms/#" class="btn btn-small"><i class="icon-trash"></i></a>
                                        </span>
                                    </td>
                                </tr>
                                <tr>
