            ...
            <div class="container">
              ...
              <form id="mws-validate" class="mws-form" method="post" action="<?= base_url() ?>admin/products/do_delete/<?= ($this->uri->segment(4)) ? $this->uri->segment(4) : '' ?>">
              <div id="mws-validate-error" class="mws-form-message error" style="display:none;"></div>
              <div class="mws-panel grid_8 mws-collapsible">
                  <div class="mws-panel-header">
                      <span><i class="icon-pencil"></i> Delete this Product : <?= $item->title ?></span>
                    </div>
                          ...
                          <div class="mws-form-inline">
                              ...
                              <div class="mws-form-row">
                                  ...
                                  <div class="mws-form-item small readonly">
                                      ...
                                      <?= form_input('title', $item->title, 'readonly="readonly" class="required" title="Product Title" rel="tooltip" data-placement="right"'); ?>
                                    </div>
                              </div>
